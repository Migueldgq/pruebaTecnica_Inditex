  ...
  return (
    <header className="">
      <div className="flex flex-row items-center justify-between px-6 pt-2">
        <Link href={"/"}>
          <h1 className="font-bold text-blue-900">Podcaster</h1>
        </Link>
        {isLoading === true && ( // Mostrar el spinner solo si isLoading es true
          <div role="status">
            <svg
              aria-hidden="true"
      ...
      <hr className="h-px w-full my-2 bg-gray-400 border-0 " />
    </header>
  );
};
